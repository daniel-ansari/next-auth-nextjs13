    ...
    <>
      <div className="flex flex-wrap px-4 -mx-3 sm:px-6 xl:px-12">
        <div className="my-20">
          ...
          <p className="mt-2 text-sm text-gray-700">Already registered?<a className="font-medium text-blue-600 hover:underline" href="/auth/login">Sign in</a> to your account.</p>
        </div>
